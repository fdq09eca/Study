...
class Dog():
    def __init__(self,input_breed):
        # `input_breed` here is the argument
        self.breed = input_breed
        # self.breed is the attribute,
        # input_breed here is the assignment
        #by convention, argument, attribute, and assignment should share the same name.

sam = Dog(input_breed='Lab')
frank = Dog(input_breed='Huskie')
...
print(f'sam breed is {sam.breed}')
print(f'frank breed is {frank.breed}')
...
print(f'dog species is {sam.species}')
...
c = Circle()
print(f'Before resetting Radius, radius = {c.radius}')
print(f'A circle with radius {c.getRadius()}:\n Area is: {c.area()} \n Circumfrence is {c.circumfrence()}')
c.setRadius(2)
print(f'After resetting radius, radius = {c.radius}')
print(f'A circle with radius {c.getRadius()}:\n Area is: {c.area()} \n Circumfrence is {c.circumfrence()}')
...
class Animal():
    ...
    def report(self):
        print("report from class Animal")
...
class Dog(Animal): # Aninal is the base class; Dog is the sub-class
    def __init__(self, fur):
        Animal.__init__(self, fur)
        print("Dog created.")

    def report(self): # overwriting the Animal inherited methods
        print("report from Class Dog")

    def bark(self):
        print("Woof!")

d = Dog(fur = 'Black')
d.report() # calling Dog report(), NOT Animal report()
d.eat() # calling Animal eat()
d.bark()
print(d.fur)
...
class Book():
    ...
    def __repr__(self):
        #__repr__ it is the string representation, it behaves similarly with __str__
